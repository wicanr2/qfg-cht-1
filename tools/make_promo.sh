...
slide    "$TMP/03.png" vga_charcreate_cht.png '連烘進美術圖的屬性名,都逐字重繪成中文'
...
declare -A SEC=( [00]=6 [01]=5 [02]=6 [03]=5 [04]=6 [05]=5 [06]=5 [99]=6 )
...
ffmpeg -y -loglevel error -i "$TMP/silent.mp4" -stream_loop -1 -i /music/qfg_bgm.wav \
  ...
  "$OUT/qfg1_cht_promo.mp4"
echo "DONE: $OUT/qfg1_cht_promo.mp4  ($DUR s)"
