...
declare -A SEC=( [00]=5 [01m]=4 [02m]=5 [03c]=5 [01]=5 [04]=6 [05f]=5 [02]=6 [06cr]=4 [05]=5 [06]=4 [99]=6 )
for f in 00 01m 02m 03c 01 04 05f 02 06cr 05 06 99; do
...
ffmpeg -y -loglevel error -i "$TMP/silent.mp4" -stream_loop -1 -i /music/qfg_bgm.wav \
  ...
  "$OUT/qfg1_cht_promo_v2.mp4"
echo "DONE: $OUT/qfg1_cht_promo_v2.mp4  ($DUR s)"
